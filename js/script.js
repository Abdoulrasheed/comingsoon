$(document).ready(function (e) {
  ...
  var countDownDate = new Date("April 10, 2022 01:37:25").getTime();
  ...
  var x = setInterval(function () {
    ...
    document.getElementById("day").innerHTML =
      daysLength == 1 ? "0" + days : days;
    document.getElementById("hour").innerHTML =
      hourLength == 1 ? "0" + hours : hours;
    document.getElementById("min").innerHTML =
      minLength == 1 ? "0" + minutes : minutes;
    document.getElementById("second").innerHTML =
      secondsLength == 1 ? "0" + seconds : seconds;
  ...
  isAndroid == true
    ? $(".seconds-holder .round").addClass("mob_trans")
    : $(".seconds-holder .round").removeClass("mob_trans");
  ...
  function get_desktop() {
    ...
    navigator.userAgent.match(/iemobile/i) == null
      ? $(".countdown-caption").addClass("desktop")
      : $(".countdown-caption").removeClass("desktop");
  }
  get_desktop();
  $(window).resize(function () {
    get_desktop();
